export const GRAPH_TEMPLATE: any = {
  product : {
    properties : {
      ...
      MainTitleString : "0300911 Streamflow",
    ...
    subProducts : [ {
      ...
      data : [ {
        properties : {
          ...
          SymbolSize : "0",
          SymbolStyle : "None",
          TSAlias : "0300911-Streamflow",
          TSID : "0300911.DWR.DivTotal.Month~StateMod~/data-maps/data-ts/0300911.DWR.DivTotal.Month.stm",
          XAxis : "Bottom",
          YAxis : "Left"
        }
      } ],
