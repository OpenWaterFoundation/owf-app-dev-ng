...
// var dot;
// // declare global {
// // 	interface Window { properties: any }
// // }
...
// @Component({
//   selector: 'gapminderv6',
//   template: `<p>gapminderv6 works!</p>`,
//   styleUrls: []
// })
// export class gapminderRef {
// 	public gapminder(configPath) {
...
// 		 */
// 		(window as any).properties = new Properties(configurationFile);
	
// 		/**
// 		 * Assigning object's properties to the local 'properties' variable
// 		 */
// 		var properties = (window as any).properties;
...
// 		 */
// 		 (window as any).demensions = data.demensions;
// 		 var demensions = (window as any).demensions;
...
// 		(window as any).currYear = demensions.dateMin;   //made global for back and forward functions
...
// 		(window as any).displayAll = true;
// 		(window as any).tracer = (properties.TracerNames == "" || !properties.TracerNames) ? false : true; // made global for functions outside wrapper
...
// 		 */
// 		 (window as any).precisionUnit = parsePrecisionUnits(properties.TimeStep);
...
// 		// window tip 
// 		(window as any).tip = d3.select('body')
// 			.append('div')
// 			.attr('class', 'tip')
...
// 				(window as any).tip.transition().duration(0);
// 			})
// 			.on('mouseout', function (d, i) {
// 				(window as any).tip.style('display', 'none');
// 			});
...
// 						if ((window as any).firstClick) {
// 							selectMultiple = false;
// 							legendButton(d, selectMultiple);
// 							(window as any).firstClick = false;
// 						} else {
// 							selectMultiple = true;
// 							legendButton(d, selectMultiple);
// 						}
