...
export class Properties {
	...
	constructor(configPath: string) {
		...
		// TODO: Can the service be used in this class so relative paths can be used?
		var _this = this;
		...
		$.ajax({
			...
			error: function(error) {
				throw new Error("(*)Config file not found, or Config file has error as JSON format");
			},
			success: function(data) {
				_this.check_properties(data.Properties);
	...
	check_properties(properties: any) {
