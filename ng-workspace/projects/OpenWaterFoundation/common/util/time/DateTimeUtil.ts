...
export class DateTime {
  ...
  */
  static FORMAT_MM: number = 5;
  /**
  The following formats a date as follows:  "MM-DD".
  */
  static FORMAT_MM_DD: number = 6;
  /**
  The following formats a date as follows:  "MM/DD".
  */
  static FORMAT_MM_SLASH_DD: number = 7;
  /**
  The following formats a date as follows:  "MM/DD/YY".
  */
  static FORMAT_MM_SLASH_DD_SLASH_YY: number = 8;
  /**
  The following formats a date as follows:  "MM/DD/YYYY".
  */
  static FORMAT_MM_SLASH_DD_SLASH_YYYY: number = 9;
  /**
  The following formats a date as follows:  "MM/DD/YYYY HH".
  */
  static FORMAT_MM_SLASH_DD_SLASH_YYYY_HH: number = 10;
  /**
  The following formats a date as follows:  "MM-DD-YYYY HH".
  */
  static FORMAT_MM_DD_YYYY_HH: number = 11;
  /**
  ...
  */
  static FORMAT_YYYY_MM_DD_HH_mm_ZZZ: number = 22;
  /**
  The following formats a date as follows:  "YYYY-MM-DD HH:mm:SS".
  */
  static FORMAT_YYYY_MM_DD_HH_mm_SS: number = 23;
  /**
  The following formats a date as follows:  "YYYY-MM-DD HH:mm:SS:hh".
  */
  static FORMAT_YYYY_MM_DD_HH_mm_SS_hh: number = 24;
  /**
  ...
  */
  addInterval (interval: number, add: number): void {
  ...
  */
  ...
  static copyConstructor(t: DateTime): DateTime {
  ...
  */
  greaterThan (t: DateTime): boolean {
    if (!this.__time_only) {
  ...
  */
  lessThanOrEqualTo (d: DateTime): boolean {
    return !this.greaterThan(d);
  }

  /**
   * Parse a string and initialize a DateTime.  The time zone will be set by default
   * but the PRECISION_TIME_ZONE flag will be set to false meaning that the time
   * zone is not used. If only a time format is detected, then the TIME_ONLY flag
   * will be set in the returned instance. This routine is the inverse of toString().
   ...
   * If more specific handling is needed, use the method version that accepts a
   * format specifier.
  ...
  static parse(dateString: string): DateTime {
    ...
    else if ((length === 26) && ((dateStringNoTimeZone.charAt(19) === ':') || (dateStringNoTimeZone.charAt(19) === '.'))) {
      // The date is:
      //    YYYY-MM-DD HH:mm:SS:ssssss
      //    YYYY-MM-DD HH:mm:SS.ssssss
      dateTime = this.parse3( dateStringNoTimeZone, DateTime.FORMAT_YYYY_MM_DD_HH_mm_SS_MICRO, 0);
    }
    else if ((length === 29) && ((dateStringNoTimeZone.charAt(19) === ':') || (dateStringNoTimeZone.charAt(19) === '.'))) {
      // The date is:
      //    YYYY-MM-DD HH:mm:SS:sssssssss
      //    YYYY-MM-DD HH:mm:SS.sssssssss
      dateTime = this.parse3( dateStringNoTimeZone, DateTime.FORMAT_YYYY_MM_DD_HH_mm_SS_NANO, 0);
    }
    else if ((length >= 30) && ((dateStringNoTimeZone.charAt(19) === ':') || (dateStringNoTimeZone.charAt(19) === '.')) && dateStringNoTimeZone.charAt(29) === ' ') {
      // The date is:
      //   YYYY-MM-DD HH:mm:SS:sssssssss ZZZ...
      //   YYYY-MM-DD HH:mm:SS.sssssssss ZZZ...
      dateTime = this.parse3(dateStringNoTimeZone, DateTime.FORMAT_YYYY_MM_DD_HH_mm_SS_NANO_ZZZ, 0);
    }
    else if ((length >= 27) && ((dateStringNoTimeZone.charAt(19) === ':') || (dateStringNoTimeZone.charAt(19) === '.')) && dateStringNoTimeZone.charAt(26) === ' ') {
      // The date is:
      //   YYYY-MM-DD HH:mm:SS:ssssss ZZZ...
      //   YYYY-MM-DD HH:mm:SS.ssssss ZZZ...
      dateTime = this.parse3(dateStringNoTimeZone, DateTime.FORMAT_YYYY_MM_DD_HH_mm_SS_MICRO_ZZZ, 0);
    }
    else if ((length >= 24) && ((dateStringNoTimeZone.charAt(19) === ':') || (dateStringNoTimeZone.charAt(19) === '.')) && dateStringNoTimeZone.charAt(23) === ' ') {
      // The date is:
      //   YYYY-MM-DD HH:mm:SS:sss ZZZ...
      //   YYYY-MM-DD HH:mm:SS.sss ZZZ...
      dateTime = this.parse3(dateStringNoTimeZone, DateTime.FORMAT_YYYY_MM_DD_HH_mm_SS_MILLI_ZZZ, 0);
    }
    else if ((length >= 23) && ((dateStringNoTimeZone.charAt(19) === ':') || (dateStringNoTimeZone.charAt(19) === '.')) && dateStringNoTimeZone.charAt(22) === ' ') {
      // The date is:
      //   YYYY-MM-DD HH:mm:SS:hh ZZZ...
      //   YYYY-MM-DD HH:mm:SS.hh ZZZ...
      dateTime = this.parse3(dateStringNoTimeZone, DateTime.FORMAT_YYYY_MM_DD_HH_mm_SS_hh_ZZZ, 0);
    }
    else if ((length >= 23) && dateStringNoTimeZone.charAt(19) === ' ') {
      // The date/time is:
  ...
  */
  round (direction: number, interval_base: number, interval_mult: number): void {
  ...
  setMinute(m: number): void {	
    if((this.__behavior_flag & DateTime.DATE_STRICT) !== 0){
      if(m > 59 || m < 0) {
          ...
          console.warn(2, "DateTime.setMinute", message);
          // throw new IllegalArgumentException (message);
      }
    }
      this.__minute = m;
  ...
  */
  setPrecisionOne (behavior_flag: number): DateTime {
  ...
  @return this DateTime instance, which allows chained calls.
  */
  setPrecisionTwo (behavior_flag: number, cumulative: boolean): DateTime {
  ...
  */
  setTimeZone(zone: string): DateTime
  ...
  */
  toStringFull (format: number): string {
...
export class TimeUtil {
  ...
  */
  static ABSOLUTE_DAY_DATUM: number = 657071;
  ...
  */
  static BLANK_YEA: number = 9999;
  static BLANK_MONTH: number = 99;
  static BLANK_DAY: number = 99;
  static BLANK_HOUR: number = 99;
  static BLANK_MINUTE: number = 99;
  static BLANK_SECOND: number = 99;
  ...
  */
  static LOOKUP_TIME_ZONE_ONCE: number = 1;
  ...
  */
  static LOOKUP_TIME_ZONE_ALWAYS: number	= 2;
  
  /**
  Abbreviations for months.
  */
  static MONTH_ABBREVIATIONS: string[] = [ "Jan", "Feb", "Mar", "Apr",
              "May", "Jun", "Jul", "Aug",
              "Sep", "Oct", "Nov", "Dec" ];
  ...
  */
  static MONTH_NAMES: string[] = [	"January", "February", "March",	
              "April", "May", "June",
  ...
  */
  static DAY_ABBREVIATIONS: string[] = [	"Sun", "Mon", "Tue",
                "Wed", "Thu", "Fri",
                "Sat" ];
  ...
  Full names for months.
  */
  static DAY_NAMES: string[] = [		"Sunday", "Monday",
                "Tuesday", "Wednesday",
                "Thursday", "Friday",
                "Saturday" ];
  ...
  */
  static MONTH_DAYS: number[] = [ 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 ];
  
  /**
  For a month, the number of days in the year passed on the first day of the
  month (non-leap year).
  */
  static MONTH_YEARDAYS: number[] = [	0, 31, 59, 90, 120, 151,
  ...
  static _local_time_zone_string: string = "";
  static _local_time_zone_retrieved: boolean = false;
  static _time_zone_lookup_method: number = TimeUtil.LOOKUP_TIME_ZONE_ONCE;
  ...
  @param year Year.
  */
  static absoluteMonth (month: number, year: number): number {
  ...
  */
  static formatDateTime (dt: DateTime, format: string): string {
  ...
  */
  static formatDateTimeFinal (d0: DateTime, yearType: YearType, format0: string): string {
   ...
   */
  static formatTimeString(d0: DateTime, formatString: string): string {
  ...
  */
  static formatYear(year: number, len: number): number {
  ...
  */
  static formatYearFull(year0: number, len: number, allow_future: boolean): number {
    var	year: number;
  ...
  */
  static getSystemTimeString (format: string): string {
  ...
  */
  static numDaysInMonthObject (dt: DateTime): number {
  ...
  */
  static numDaysInMonthsThree (month0: number, year0: number, n: number): number {
  ...
  */
  static numDaysInMonths (	month0: number, year0: number, month1: number, year1: number): number {
